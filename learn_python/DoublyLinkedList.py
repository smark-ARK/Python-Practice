...
# doubyLL.insertNode(2,0)
# doubyLL.insertNode(6,0)
...
print([node.value for node in doublyLL]) # [5]
 
# insert at the beginning
doublyLL.insertNode(0, 0)
print([node.value for node in doublyLL]) # [0, 5]
 
# insert at the end
doublyLL.insertNode(0, -1)
print([node.value for node in doublyLL]) # [0, 5, 0]
 
# insert in the middle
doublyLL.insertNode(10, 1)
print([node.value for node in doublyLL]) # [0, 10, 5, 0]
